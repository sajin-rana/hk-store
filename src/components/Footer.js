          ...
          <div className='row align-items-center'>
            <div className='col-5'>
              <div className='footer-top-data d-flex gap-30 align-items-center'>
                ...
                <h2 className='text-white'>Sign Up for Newletter</h2>
              </div>
            </div>
            <div className='col-7'>
            ...
            <div className='col-4'>
              ...
              <div className='footer-links d-flex flex-column'>
                <address className='text-white fs-6'>
                  123 hello street <br /> Central, Hongkong <br/> Pincode:12345
                </address>
                <a href='tel:+852 1234 5678' className='mt-1 d-block mb-2 text-white'>
                  +852 1234 5678
                </a>
                <a 
                href='mailto:hellohongkong@gmail.com'
                className='mt-0 d-block mb-4 text-white'>
                  hellohongkong@gmail.com
                </a>
        ...
        <div className='container-xxl'>
          <div className='row'>
            <div className='col-12'>
              ...
              &copy; { new Date().getFullYear()} Powered by Sajin's Corner{" "}</p>
            </div>
          </div>
        </div>
      </footer>
